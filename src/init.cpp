    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Becoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  becoind [options]                     " + "\n" +
                  "  becoind [options] <command> [params]  " + _("Send command to -server or becoind") + "\n" +
                  "  becoind [options] help                " + _("List commands") + "\n" +
                  "  becoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: becoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Becoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Becoin is probably already running."), strDataDir.c_str()));
